<template>
  <div class="container">
    <div class="content">
      <p>
        炒饭重视用户的隐私。您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务
        炒饭 时
        ，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。本《隐私政策》与您所使用的炒饭服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
      </p>
      <p>
      ...
      <p>您在使用我们的服务时，向我们提供的相关个人信息，例如电子邮件等；</p>
      <p>
        您通过我们的服务向其他方提供的共享信息，以及您使用我们的服务时所储存的信息。
      </p>
      <p>
        <strong>其他方分享的您的信息</strong>
      </p>
      ...
      <blockquote>
        您通过具有定位功能的移动设备使用我们的服务时，通过GPS或WLAN等方式收集的您的地理位置信息；
      </blockquote>
      <blockquote>
      ...
      <blockquote>向您提供服务；</blockquote>
      <blockquote>
        在我们提供服务时，用于身份验证、客户服务、安全防范、诈骗监测、存档和备份用途，确保我们向您提供的产品和服务的安全性；
      </blockquote>
      <blockquote>帮助我们设计新服务，改善我们现有服务；</blockquote>
      <blockquote>
        使我们更加了解您如何接入和使用我们的服务，从而针对性地回应您的个性化需求，例如语言设定、位置设定、个性化的帮助服务和指示，或对您和其他用户作出其他方面的回应；
      </blockquote>
      <blockquote>向您提供与您更加相关的广告以替代普遍投放的广告；</blockquote>
      <blockquote>
        评估我们服务中的广告和其他促销及推广活动的效果，并加以改善；
      </blockquote>
      <blockquote>软件认证或管理软件升级；</blockquote>
      <blockquote>让您参与有关我们产品和服务的调查。</blockquote>
      <p>
      ...
      <blockquote>向您提供我们的服务；</blockquote>
      <blockquote>实现“我们可能如何使用信息”部分所述目的；</blockquote>
      <blockquote>
        履行我们在本《隐私政策》中的义务和行使我们的权利；
      </blockquote>
      <blockquote>理解、维护和改善我们的服务。</blockquote>
      <p>
      ...
      <blockquote>遵守适用的法律法规；</blockquote>
      <blockquote>遵守法院命令或其他法律程序的规定；</blockquote>
      <blockquote>遵守相关政府机关的要求；</blockquote>
      <blockquote>
      ...
      <blockquote>
        第三方互联网服务供应商，以及与下列有关的第三方商品或服务：食物和餐饮、体育、音乐、电影、电视、现场表演及其他艺术和娱乐、书册、杂志和其他刊物、服装和配饰、珠宝、化妆品、个人健康和卫生、电子、收藏品、家用器皿、电器、家居装饰和摆设、宠物、汽车、酒店、交通和旅游、银行、保险及其他金融服务，以及我们认为可能与您相关的其他商品或服务。
      </blockquote>
      <p>
        如您不希望我们将您的个人信息用作前述广告用途，您可以通过我们在广告中提供的相关提示，或在特定服务中提供的指引，要求我们停止为上述用途使用您的个人信息。
      </p>
      <h4>我们可能向您发送的邮件和信息</h4>
      <h4 style="white-space: normal">
        <span
          style="
            color: rgb(23, 26, 29);
            font-family: Microsoft YaHei, Segoe UI, system-ui, Roboto,
              Droid Sans, Helvetica Neue, sans-serif, Tahoma,
              Segoe UI SymbolMyanmar Text, 微软雅黑;
      ...
      <p>
        <span style="font-size: 16px">
          <span
            ...
            "
            >1.
            读写外部存储权限：当您使用炒饭APP中头像设置、评论或分享、将文件下载至本地或打开使用本地文件时，您可以通过开启存储权限使用或保存图片、视频或文件。若您不开启此权限，您将无法使用与存储卡读取或缓存相关的功能，但不影响您使用其他服务。</span
          ><br /><br />
          <span
            style="
              color: rgb(23, 26, 29);
            ...
            "
            >2.
            相册权限：当您使用炒饭App中的头像设置、评论或分享、将文件下载至本地或打开使用本地文件时，您可以通过开通相册权限以便上传设备中的图片或视频。若您不开启此权限，您将无法使用图片或视频上传相关的功能，但不影响您使用其他服务。</span
          ><br /><br />
          <span
            style="
              color: rgb(23, 26, 29);
            ...
            "
            >3.
            相机权限：当您使用炒饭App中的头像设置、评论或分享、将文件下载至本地或打开使用本地文件时，您可以通过开通相机权限以便进行实时拍摄并上传图片或视频进行晒图或分享、设置头像。若您不开启此权限，您将无法使用图片或视频拍摄相关的功能，但不影响您使用其他服务。</span
          ><br /><br />
          <span
            style="
              color: rgb(23, 26, 29);
            ...
            "
            >4.
            位置权限：当您使用炒饭App中的特定区域产品或服务时，您可以通过开启位置权限以便查看或获取当前所在区域的产品或服务。若您不开启此权限，您将无法收到基于当前所在位置进行的推荐，但不影响您使用其他服务。</span
          ><br /><br />
          <span
            style="
              color: rgb(23, 26, 29);
            ...
            "
            >5.
            麦克风权限：当您使用炒饭App中的评论或分享时，您可以开启麦克风权限拍摄视频分享到炒饭，若您不开启此权限，您将无法使用视频拍摄相关的功能，但不影响您使用其他服务。</span
          ></span
        ><br />
      </p>
      ...
      <p>
        <span style="font-size: 16px">
          <span
            ...
            "
            >1.
            com.umeng(友盟)，会收集你的设备ID，使用情况和崩溃信息，为了给您更好的体验。</span
          ><br /><br />
          <span
            style="
              color: rgb(23, 26, 29);
            ...
            "
            >2.
            com.huawei.hms、com.huawei.agconnect(华为推送)，会收集你的设备信息，以便给你做消息推送。</span
          ><br /><br />
          <span
            style="
              color: rgb(23, 26, 29);
              ...
              background-color: rgb(255, 255, 255);
            "
            >3. com.aliyun.push(阿里云推送),
            会收集你的设备信息，以便为你推送消息。</span
          ><br /><br
        /></span>
      </p>
      <h4>
      ...
      <h4 style="white-space: normal">注销账户：</h4>
      <p style="white-space: normal">
        可通过App私聊【cijianzy】与我们取得联系，我们一般会在15天内对您的反馈作出答复。我们承诺不会对您账号注销请求设置不合理的障碍或条件。请注意，一旦您注销炒饭账号，可能会无法使用炒饭的部分产品和服务，同时您先前积累的数据可能会不可逆地被永久删除，因此请您谨慎操作<span
          style="
            background-color: rgb(255, 255, 255);
            color: rgb(23, 26, 29);
            font-family: Microsoft YaHei, Segoe UI, system-ui, Roboto,
